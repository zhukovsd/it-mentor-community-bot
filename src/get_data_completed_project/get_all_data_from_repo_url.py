...
def get_info_from_url(url: str, lang_project: str) -> ProjectDataSerializer:
    """
    ...
    :param lang_project: Передаем язык программирования проекта.
...
if __name__ == '__main__':
    # Test func
    object_project_data = get_info_from_url(URL_REPO, 'Java')
    print(
        f'url владельца репо {object_project_data.url_owner_repo}',
        f'url репо {object_project_data.repository_url}',
