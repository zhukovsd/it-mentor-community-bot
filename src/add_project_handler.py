...
from src.get_data_completed_project_package import (
    get_info_from_url,
    parsing_url_from_message
)
from src.google_sheets_package import AddDataProjectInGSheet
...
def __connecting_modules_to_add_data_to_gsheets(message: str, lang_project: str, type_project: str):
    ...
    """
    url = parsing_url_from_message(message)
    project_data_obj = get_info_from_url(
        url=url,
        lang_project=lang_project,
        type_project=type_project
    )
    add_in_sheets_obj = AddDataProjectInGSheet()
